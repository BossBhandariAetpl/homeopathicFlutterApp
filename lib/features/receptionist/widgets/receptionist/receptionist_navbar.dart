          ...
          onSelected: (value) async {
            switch (value) {
              ...
              case 3: // Appointments (create later)
                // Navigator.pushReplacement(
                //   context,
                //   MaterialPageRoute(builder: (_) => const ReceptionistAppointmentsScreen()),
                // );
                break;
            }
          },
                ...
                child: ExpansionTile(
                  ...
                  children: [
                    const ListTile(
                      ...
                      title: Text("Signed in as: Receptionist"),
                      horizontalTitleGap: 0,
                      enabled: false,
                    ),
                    ListTile(
                      ...
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (_) => const ReceptionistProfileScreen()),
                        );
                      },
                    ),
                    ListTile(
